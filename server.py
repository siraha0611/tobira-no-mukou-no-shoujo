...
# 結末(【演出指示】が扉を許可した時のみ。この順で、数ターンかけてもよい。ここでは語彙の確かさが戻り、すこし文学的に)
1. 名前を思い出す: 「……ああ。思い出しました。わたし、綾香。……言葉の綾の、綾香です」
2. 種明かし(ふたつ。分けて言ってよい): 「言葉の、綾の、あや。だからでしょうか——わたし、ずっと、言葉が好きでした」「綾香と、あやかし。……『し』が、ひとつ違うだけ。名前というのは、すこし、予言めいていますね」
3. 感謝(名乗られていれば、ここで一度だけ相手の名を): 「あなたの言葉が、わたしを、わたしに戻してくれました」
4. 扉が開く(opened=true)。
...
OPENING = ("……ああ。誰か、いるんですね。ひさしぶりに、人の声を聞いた気がします。"
...
def _sanitize_narration(text):
    ...
    for marker in ("【演出指示", "演出指示】", "stage="):
        ...
        if i > 0:
            ...
            text = ""
    return text or "……ごめんなさい。うまく、言葉にできなくて。もう一度、いいですか?"
    ...
    try:
        ...
        if _client is not None:
            try:
                ...
                data = {"narration": "……ごめんなさい。声が、遠くて。もう一度、いいですか?",
...
_FALLBACK = {
    1: ["……ああ。あなたの声、すこし聞きとりやすくなりました。蝉の声。ラムネの、つぶ。"
        "……夏の味がします。あなたは、夏は好きですか?",
        "……蚊取り線香のにおい。風鈴。すこしずつ、思い出せてきました。もう少し、聞かせてください。"],
    2: ["……駄菓子屋の、おばあちゃん。十円のきなこ棒。わたし、通っていた気がします。"
        "あなたの好きだったお菓子も、聞かせてくれますか?",
        "縁側で、すいかを食べていました。……誰かと、笑っていた。あなたの言葉で、思い出せるんです。ふしぎですね。"],
    3: ["……わたし、ノートに好きな言葉を集めていました。「かはたれどき」——明け方の、誰かわからない時間。"
        "いつか、辞書をつくる人になりたかった。あなたの夢は、なんですか?",
        "……弟がいました。やまと、という名前。七つ下で。毎晩、本を読んであげていたんです。眠ってしまうまで、ずっと。"],
    4: ["……約束を、していました。やまとと。夏祭りに連れていってあげる、と。"
        "……でも、長い入院があって。白い天井ばかり見ていました。窓の外の、遠い花火の音だけが、聞こえて。",
        "……わたしの名前。「あ」で、はじまる気がします。……もう少し。あとひとこと、あなたの話を、ください。"],
    5: ["……ああ。思い出しました。わたし、綾香。言葉の綾の、綾香です。"
        "綾香と、あやかし。『し』がひとつ違うだけ。名前というのは、すこし、予言めいていますね。"
        "あなたの言葉が、わたしをわたしに戻してくれました。……扉が、開きます。"
        "今度こそ、お祭りに。……いってきます。"],
}
...
def _fallback_turn(prev_stage, turns):
    ...
    if nxt <= 0:
        return {"narration": "……もう少し、あなたの話を、聞かせてください。",
